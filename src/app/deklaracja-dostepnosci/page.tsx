        ...
        <div className="container mx-auto px-4 py-16 max-w-4xl">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8">
                <div className="text-center space-y-4">
                    <h1 className="text-4xl font-bold text-gray-900">Deklaracja Dostępności</h1>
                ...
                <section className="prose prose-gray max-w-none">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Data publikacji i aktualizacji</h2>
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Status zgodności z ustawą</h2>
                    <p className="text-gray-600 leading-relaxed">
                        Strona internetowa jest <strong>częściowo zgodna</strong> z ustawą o dostępności cyfrowej
                        z powodu niezgodności lub wyłączeń wymienionych poniżej.
                    </p>

                    <h3 className="text-xl font-semibold text-gray-900 mt-6 mb-3">Treści niedostępne</h3>
                    <ul className="list-disc pl-6 text-gray-600 space-y-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Przygotowanie deklaracji dostępności</h2>
                    <ul className="list-disc pl-6 text-gray-600 space-y-2">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Informacje zwrotne i dane kontaktowe</h2>
                    <p className="text-gray-600 leading-relaxed">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Procedura wnioskowo-skargowa</h2>
                    <p className="text-gray-600 leading-relaxed">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mt-8 mb-4">Dostępność architektoniczna</h2>
