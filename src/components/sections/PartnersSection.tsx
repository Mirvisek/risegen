                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    {ngoPartners.length > 0 && (
                        <div className="flex flex-col items-center space-y-6">
                            <h3 className="text-xl font-semibold text-gray-900 border-b-2 border-indigo-500 pb-2">
                                NGO
                            </h3>
                    ...
                    {otherPartners.length > 0 && (
                        <div className="flex flex-col items-center space-y-6">
                            <h3 className="text-xl font-semibold text-gray-900 border-b-2 border-gray-500 pb-2">
                                Inni Partnerzy
                            </h3>
                            <div className="grid grid-cols-2 gap-8 w-full place-items-center">
...
function PartnerLogo({ partner }: { partner: any }) {
    return (
        <a
            ...
            className={`relative w-32 h-20 transition duration-300 hover:scale-105 ${!partner.website ? "cursor-default pointer-events-none" : ""}`}
            title={partner.name}
        >
            <Image
                src={partner.logo}
