                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="bg-white rounded-lg p-6 max-w-sm w-full space-y-4 shadow-xl relative animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="text-center">
                            ...
                            <h3 className="text-lg font-medium text-gray-900">Usuń slajd</h3>
                        ...
                        <div className="flex gap-3 mt-6">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className="flex-1 bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 text-sm font-medium disabled:opacity-50 flex justify-center items-center"
                            >
