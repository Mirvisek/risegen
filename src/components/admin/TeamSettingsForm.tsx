            ...
            <div className="space-y-4">
                <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                        <label htmlFor="showBoard" className="font-medium text-gray-700">Zarząd</label>
                        <p className="text-gray-500">Sekcja z prezesem i wiceprezesami.</p>
                    </div>
                </div>
                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                        <label htmlFor="showOffice" className="font-medium text-gray-700">Biuro</label>
                        <p className="text-gray-500">Sekcja pracowników administracyjnych.</p>
                    </div>
                </div>
                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                        <label htmlFor="showCoordinators" className="font-medium text-gray-700">Koordynatorzy</label>
                        <p className="text-gray-500">Osoby odpowiedzialne za projekty.</p>
                    </div>
                </div>
                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3 text-sm">
                        <label htmlFor="showCollaborators" className="font-medium text-gray-700">Współpracownicy</label>
                        <p className="text-gray-500">Partnerzy i inni członkowie zespołu.</p>
                    </div>
                </div>
            </div>
