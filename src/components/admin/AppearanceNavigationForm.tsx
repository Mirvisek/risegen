...
export function AppearanceNavigationForm({ config }: Props) {
    ...
    return (
        <form action={formAction} className="bg-white shadow sm:rounded-lg p-6 space-y-6">
            <h3 className="text-lg font-medium leading-6 text-gray-900 border-b pb-2">Nawigacja: Menu "O Nas"</h3>
            <p className="text-sm text-gray-500">Zarządzaj podzakładkami wyświetlanymi w rozwijanym menu "O Nas".</p>
            ...
            <div className="space-y-4">
                {links.map((link, index) => (
                    <div key={index} className="flex items-center gap-3 p-3 bg-gray-50 rounded-md border border-gray-200">
                        ...
                        <button
                            ...
                            className="p-2 text-red-500 hover:bg-red-50 rounded-full transition self-end sm:self-center"
                            title="Usuń link"
                        >
