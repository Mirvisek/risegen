...
export function PartnerForm({ partner }: { partner?: any }) {
    ...
    return (
        <form action={formAction} className="space-y-6 max-w-xl bg-white p-6 rounded-xl shadow-sm border animate-in fade-in duration-500">
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700">Nazwa Partnera</label>
                <input
                    name="name"
            ...
            <div>
                ...
                <select
                    ...
                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2 text-black bg-white"
                >
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700">Strona WWW (opcjonalnie)</label>
                <input
                    name="website"
            ...
            <div>
                ...
                <div className="mt-2 mb-4">
                    {logo ? (
                        <div className="relative group w-40 h-24 bg-gray-50 rounded-lg overflow-hidden border flex items-center justify-center">
                        ...
                        <label className="cursor-pointer bg-white border border-dashed border-gray-300 rounded-md px-6 py-8 flex flex-col items-center gap-2 hover:bg-gray-50 transition shadow-sm text-sm font-medium text-gray-700 w-full">
                            ...
                            <span className="text-xs text-gray-500">Maks. 10MB (PNG/SVG/JPG)</span>
                            <span className="text-xs text-gray-400">Rekomendowane: 400x200px (proporcje 2:1)</span>
