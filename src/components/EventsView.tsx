    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-12 space-y-12">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 bg-white dark:bg-gray-900 p-6 md:p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
                    <div className="space-y-4">
                        ...
                        <div className="calendar-container border rounded-xl overflow-hidden dark:invert dark:hue-rotate-180 dark:brightness-90">
                            <Calendar
                        ...
                        {googleCalendarId && (
                            <Link
                                ...
                                target="_blank"
                                className="inline-flex items-center gap-2 text-sm text-indigo-600 hover:text-indigo-700 font-medium transition"
                            >
                                ...
                                {filteredEvents.length > 0 ? (
                                    filteredEvents.map(event => (
                                        <motion.div
                                            ...
                                            exit={{ opacity: 0, x: -20 }}
                                            className="group bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-transparent hover:border-indigo-300 dark:hover:border-indigo-700 transition"
                                        >
                                    ...
                                    <div className="flex flex-col items-center justify-center p-8 text-center bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-dashed border-gray-200 dark:border-gray-800 h-full">
                                        <CalendarIcon className="h-8 w-8 text-gray-300 mb-2" />
                                        <p className="text-gray-500 text-sm">Brak zaplanowanych wydarzeń na ten dzień.</p>
                                    </div>
                                )}
                            </AnimatePresence>
                        </div>
                    ...
                    {events.map((event, i) => (
                        ...
                        >
                            <div className="relative aspect-video overflow-hidden">
                                {JSON.parse(event.images)[0] ? (
                                    ...
                                    <div className="w-full h-full bg-indigo-50 dark:bg-indigo-900/20 flex items-center justify-center">
                                        <CalendarIcon className="h-12 w-12 text-indigo-200" />
                                    </div>
                                )}
                                <div className="absolute top-4 left-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-indigo-600 dark:text-indigo-400 shadow-sm">
                            ...
                            <div className="p-6 flex-1 flex flex-col">
                                ...
                                <Link
                                    href={`/wydarzenia/${event.slug}`}
                                    className="inline-flex items-center justify-center w-full bg-gray-900 dark:bg-indigo-600 text-white dark:text-black font-bold py-3 rounded-xl hover:bg-gray-800 dark:hover:bg-indigo-500 transition"
                                >
